    ...
    <div class="container login">
        <div class="row">
            <div class="col-md-8 mx-auto card shadow mb-5">
                <div class="mb-3 mt-3">
                    <h3 class="text-center mt-5 mb-4">Forgot your password ?</h3>
                    <?php echo $this->session->flashdata('message'); ?>
                </div>
                <form action="<?php echo base_url('C_article/forgot_password'); ?>" method="POST">
                ...
                <div class="form-group">
                    <button class="btn btn-primary float-right mb-4 form-control">Reset Password</button>
                </div>
                </form>
                <div class="text-center mx-auto" style="margin-bottom:98px;">
                    <a href="<?= base_url('C_article/login'); ?>">Back to Login</a>
                </div>                
            </div>
        </div>
    </div>
